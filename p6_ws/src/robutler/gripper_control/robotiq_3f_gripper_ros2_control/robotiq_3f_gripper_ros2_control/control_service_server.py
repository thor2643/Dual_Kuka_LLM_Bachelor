...
class GripperServiceServer(Node):
    ...
    * Default IP is 172.31.1.69 and the port is 502
    ...
    def output_registers_msg_to_list(self, output_registers_msg):
        ...
        # Changed by Group 565 to allow rMOD to be 0,1,2 or 3 by padding binary
        rMOD = f"{int(rMOD):02b}"
        byte_0_bits = f"000{rATR}{rGTO}{rMOD}{rACT}" # Removed leading 0 before rMOD to allow for the new padding method
