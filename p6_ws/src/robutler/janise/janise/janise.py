...
class LLMNode(Node):
    def __init__(self):
        ...
        self.real_workflow = StateGraph(MessagesState)
        ...
        self.real_workflow.add_edge(START, "success_detector")
    ...
    def real_system(self, request, response):
        ...
        for function_num, details in tool_calls.items():
            ...
            try:
                ...
                for event in self.real_workflow_manager.stream({"messages": [query]}, self.real_config, stream_mode="values"):
