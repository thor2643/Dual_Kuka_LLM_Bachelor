...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '1280, 720, 30', 'description': 'color stream profile'}, ###OBS here you control resulution and framerate for color
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '1280, 720, 30', 'description': 'depth stream profile'}, ####1280, 720, 30 and here for depth
                           ...
                           {'name': 'pointcloud.stream_filter',     'default': '2', 'description': 'texture stream for pointcloud'}, ###used to be 2
                           {'name': 'pointcloud.stream_index_filter','default': '0', 'description': 'texture stream index for pointcloud'},
                           {'name': 'pointcloud.ordered_pc',        'default': 'false', 'description': ''},
                           {'name': 'pointcloud.allow_no_texture_points', 'default': 'false', 'description': "''"}, #OBS USED TO BE FALSE
                           ...
                           {'name': 'hole_filling_filter.enable',   'default': 'true', 'description': 'enable_hole_filling_filter'}, #OBS kan være god til at fjere nuller
...
def launch_setup(context, params, param_name_suffix=''):
    ...
    if(os.getenv('ROS_DISTRO') == 'humble'): # was foxy before
