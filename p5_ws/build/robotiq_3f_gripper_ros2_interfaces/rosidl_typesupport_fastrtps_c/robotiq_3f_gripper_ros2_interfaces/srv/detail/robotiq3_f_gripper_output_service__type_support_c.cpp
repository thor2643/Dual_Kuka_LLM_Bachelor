  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotiq_3f_gripper_ros2_interfaces__srv__Robotiq3FGripperOutputService_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robotiq_3f_gripper_ros2_interfaces__srv__Robotiq3FGripperOutputService_Response;
    is_plain =
      (
